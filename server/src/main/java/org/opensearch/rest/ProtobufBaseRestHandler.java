...
* @opensearch.api
*/
public abstract class ProtobufBaseRestHandler implements ProtobufRestHandler {
    ...
    * implementations can override {@link ProtobufBaseRestHandler#responseParams()} to indicate such
    * params.
    *
    ...
    *                     execution
    */
    protected abstract RestChannelConsumer prepareRequest(RestRequest request, ProtobufNodeClient client) throws IOException;
    ...
    * {@link ProtobufBaseRestHandler#prepareRequest(RestRequest, ProtobufNodeClient)}.
    *
    ...
    * @opensearch.internal
    */
    public static class Wrapper extends ProtobufBaseRestHandler {

        protected final ProtobufBaseRestHandler delegate;

        public Wrapper(ProtobufBaseRestHandler delegate) {
            this.delegate = Objects.requireNonNull(delegate, "ProtobufBaseRestHandler delegate can not be null");
        }
        ...
        @Override
        protected RestChannelConsumer prepareRequest(RestRequest request, ProtobufNodeClient client) throws IOException {
    ...
    */
    public RestChannelConsumer sendTask(String nodeId, ProtobufTask task) {
        return channel -> {
